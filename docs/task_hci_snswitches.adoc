...
== Create the configuration file
You can configure a switch by using the configuration files you create. Choose from one of the following options to create the configuration file for the faulty switch.
