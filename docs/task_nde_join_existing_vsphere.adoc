...
+
IMPORTANT: The plug-in not compatible with VMware vCenter Server 6.5 for VCP 4.7 and later. For more information about supported vSphere versions, see the release notes for https://docs.netapp.com/us-en/vcp/rn_relatedrn_vcp.html#netapp-element-plug-in-for-vcenter-server[your version of the plug-in].
