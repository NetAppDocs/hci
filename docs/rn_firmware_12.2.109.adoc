...
////
= Compute firmware 12.2.109 Release Notes
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
|CSESF-293
|When you upgrade to the version 12.2.109 compute node firmware on a H410C, H610C, H300E, H500E, or H700E node, version 14.21.1000 of the Mellanox network interface card (NIC) firmware is installed, even if it was previously at a newer version.
