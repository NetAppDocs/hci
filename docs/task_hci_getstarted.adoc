...
CAUTION: For precautions and details, see link:task:_hci_installhw.html[Install H-series hardware_^].
...
== (Optional) Monitor, upgrade, or expand NetApp HCI with the Hybrid Cloud Control
