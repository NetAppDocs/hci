...
Install the NetApp Configuration Advisor 5.8.1 or later network validation tool located on the link:https://mysupport-beta.netapp.com/site/tools/tool-eula/5ddb829ebd393e00015179b2[NetApp Support Tools^] to ensure network readiness. The tool validates connectivity, VLAN IDs, IP address requirements, switch connectivity and more.
