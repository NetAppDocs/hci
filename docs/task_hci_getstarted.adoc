...
For details about LACP configuration, see the following resources:

* https://www.netapp.com/us/media/tr-4820.pdf[_TR-4820: NetApp HCI Networking Quick Planning Guide_]
* link:<hci_prereqs_LACP_configuration.html>[Configure LACP for optimal storage performance]
