...
== Resolved issues - Link to BOL
See the link to the BOL for details of issues that have been resolved in this release.
...
== Known issues - link to BOL
See the link to the BOL for details of known issues in this release that might affect daily operation in some environments.
