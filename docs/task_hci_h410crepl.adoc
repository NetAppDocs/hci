...
--
Add a node back to a VMware ESXi cluster running Element Plug-in for vCenter 5.0 or later.
...
... Expand  *vSwitch0*.
... In the graphic that is displayed, remove the VM network.
+
...
... In the graphic that is displayed, select *Edit Settings*.
+
...
.. In the graphic that is displayed, select edit for *VM Network* to edit the setting as follows:
...
.. In the graphic that is displayed, select *Edit* for vMotion.
... Select *Security*, and make the following selections:
+
...
... Under Properties, set MTU to 9000, and select *OK*.
.. In the graphic that is displayed, select *Edit* for  iSCSI-B:
... Select *Security*, and make the following selections:
+
image::iscsi-b-vcp-50.gif[Shows the security selections for the iSCSI-B network.]
... Select *Teaming and failover*, and select the *Override* checkbox.
...
.. In the graphic that is displayed, select *Edit* iSCSI-A:
... Select *Security*, and make the following selections:
+
...
... Select *OK*.
... Select *Network Port Binding*, and selec *ADD*.
...	Select iSCSI-A and iSCSI-B. Select *OK*
...
--
Add a node back to a VMware ESXi cluster running Element Plug-in for vCenter 4.10 or later.
