...
--
Add a node back to a VMware ESXi cluster running Element Plug-in for vCenter 5.0 and later.
...
--
Add a node back to a VMware ESXi cluster running Element Plug-in for vCenter 4.10 and later.
