...
* You have access to login at the administrator level.
...
+
NOTE: If you log in at read-only level, you will not have access to the maintenance mode feature options.
...
+
.	Enable the maintenance mode for your selected node:
+
