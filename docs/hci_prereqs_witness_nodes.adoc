...
If your NetApp HCI installation is running Element 12.8, you must link:task_mnode_install.html#upgrade-vm-hardware[upgrade the VM hardware version on the witness node]. 
====
