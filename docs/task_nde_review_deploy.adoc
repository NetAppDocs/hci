...
+
NOTE: You cannot import the CSV file as an installation profile on the *Installation Profile* page of the NetApp Deployment Engine. The file formats are different.
