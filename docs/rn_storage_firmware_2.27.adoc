...
[.lead]
The downloadable storage firmware update package contains BMC feature enhancements and bug fixes for NetApp storage nodes.

== What's New
The storage firmware bundle version 2.27 contains various bug fixes and new features.
