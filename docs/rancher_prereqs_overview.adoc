...
** Each user cluster requires at least 3 static IP addresses, but the total number of IP addresses needed depends on the number of nodes you select to be a part of the user cluster.
