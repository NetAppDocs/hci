...
* If you plan on using DHCP addressing for the Rancher control plane or user clusters, ensure that the DHCP lease is configured to be renewed no more frequently than every 24 hours.
