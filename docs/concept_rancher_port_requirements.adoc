...
[.lead]
The following ports and URLs must be open to and from nodes running Rancher server. In addition to this list, ensure that the list of ports in the official https://rancher.com/docs/rancher/v2.x/en/installation/requirements/ports/[Rancher documentation^] are open as well.

== Required URLs
The following URLs should be accessible from Rancher server:
...
== Required ports
The following ports should be accessible from Rancher server:
