...
permalink: docs/rn_compute_firmware_2.99.html
...
////
= Compute Firmware Bundle 2.99 Release Notes
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
== What's New
Version 2.99 contains general bugfixes.
...
== Download Compute Firmware Bundle 2.99
