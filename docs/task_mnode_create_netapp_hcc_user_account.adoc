...
* For NetApp ESXi host configurations, you might need to assign the NetApp HCC role and user permissions in vCenter:
...
* Use the new NetApp HCC role to add  link:task_mnode_create_netapp_hcc_role_vcenter.html#add-an-asset-to-the-management-node[an asset] or a link:task_mnode_create_netapp_hcc_role_vcenter.html#add-a-netapp-compute-node-and-bmc-assets[compute node] to the management node.
* You can link:task_mnode_create_netapp_hcc_role_vcenter.html#controller-asset-already-exists-on-the-management-node[configure an asset] that already exists on the management node.
...
== Add a NetApp compute node and BMC assets
