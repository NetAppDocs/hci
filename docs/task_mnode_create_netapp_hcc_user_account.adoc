...
.About this task
* This procedure describes the steps available in version 6.7 of vSphere. Your vSphere user interface might differ slightly from what is described depending on the version of vSphere installed. For additional help, see link:https://docs.netapp.com/us-en/vcp/vcp_task_configure_manage_vvols.html#register-the-vasa-provider-with-vcenter[VMware vCenter documentation^].
