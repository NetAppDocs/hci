...
summary: As part of the entire NetApp HCI upgrade, you can also upgrade compute node drivers.
...
+
NOTE: The NetApp driver bundle includes one or more VMware Offline Bundle ZIP files; donot extract these ZIP files.
