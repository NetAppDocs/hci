...
[.lead]
You can enable Active IQ NetApp HCI storage monitoring and compute monitoring for NetApp HCI only if you did not already do so during installation or upgrade. You might need to use this procedure if you disabled telemetry using the NetApp HCI Deployment Engine.
