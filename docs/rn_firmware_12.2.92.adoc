...
|Manually update the BIOS to version NA3.7 and the BMC to version 6.71 on the H410C node (you can download the BIOS and BMC packages and see instructions for using them https://mysupport.netapp.com/site/products/all/details/netapp-hci/docsandkb-tab/download/62542/H410C_BIOS_3.4_BMC_6.71/downloads[here^]). After you update the BIOS and BMC, update the H410C node firmware using the compute firmware 12.2.92 package.
|===
