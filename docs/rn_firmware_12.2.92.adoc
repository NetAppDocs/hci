...
|Manually update the BIOS to version NA3.7 and the BMC to version 6.71 on the H410C node:
. Browse to the https://mysupport.netapp.com/site/products/all/details/netapp-hci/downloads-tab[NetApp HCI Downloads page^].
. Choose *Compute_Firmware_Bundle* from the list.
. Click *Go*. Instructions for updating are on the download page.
