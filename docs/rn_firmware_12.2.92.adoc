...
|Manually update the BIOS to version NA3.7 or the BMC to version 6.71 (you can download BIOS and BMC packages and see instructions for updating https://mysupport.netapp.com/site/products/all/details/netapp-hci/docsandkb-tab/download/62542/H410C_BIOS_3.4_BMC_6.71/downloads[here^]) and then update the firmware using the compute firmware 12.2.92 package.
|===
