...
[.lead]
You can store Baseboard Management Controller (BMC) administrator credentials in NetApp Hybrid Cloud Control for each of your compute nodes. This enables you to use NetApp Hybrid Cloud Control or the REST API to seamlessly upgrade BMC firmware.
