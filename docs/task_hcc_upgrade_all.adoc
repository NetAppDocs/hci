...
+
NOTE: Upgrading HealthTools is only required if the management node and Element software you are running is 11.1 or earlier. HealthTools upgrades are not required for upgrades using NetApp Hybrid Cloud Control.
