...
. link:task_hcc_upgrade_compute_node_firmware.html[Update your compute node firmware using NetApp Hybrid Cloud Control] or link:task_hcc_upgrade_compute_firmware_ansible.html[Upgrade your compute node firmware with Ansible].
