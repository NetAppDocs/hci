...
== Compute firmware
* link:rn_compute_firmware_3.0.html[Compute Firmware Bundle 2.76 Release Notes (latest)]
...
== Storage firmware
* link:rn_storage_firmware_3.0.html[Storage firmware Bundle 2.76 Release Notes (latest)]
