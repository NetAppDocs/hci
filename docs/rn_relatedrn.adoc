...
== Compute firmware
* link:rn_compute_firmware_2.179.0.html[Compute Firmware Bundle 2.179.0 Release Notes]
...
== Storage firmware
* link:rn_storage_firmware_2.182.0.html[Storage Firmware Bundle 2.182.0 Release Notes]
