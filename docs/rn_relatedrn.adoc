...
* https://library.netapp.com/ecm/ecm_download_file/ECMLP2884458[vCenter Plug-in 4.9 Release Notes^] _NEW_
...
* link:firmware_driver_versions.html[Supported firmware and driver versions] _NEW_

== Storage firmware
* link:rn_storage_firmware_2.150.html[Storage Firmware Bundle 2.150 Release Notes] _NEW_
