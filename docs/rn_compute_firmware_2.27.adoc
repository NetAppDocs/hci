...
a|To upgrade other firmware on H410C or H300E/H500E/H700E nodes and then upgrade Mellanox NIC firmware individually, perform the following steps:

. Upgrade other firmware via Compute Firmware Bundle 2.27.
. Upgrade Mellanox NIC firmware manually.
