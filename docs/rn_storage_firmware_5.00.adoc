---
sidebar: sidebar
permalink: docs/rn_storage_firmware_5.00.html
...
////
= Storage Firmware Bundle 2.XX Release Notes
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
== What's New
The storage firmware bundle version 2.XX contains various bug fixes and new features, including security vulnerability fixes. You can upgrade the storage firmware using the instructions in link:task_hcc_upgrade_storage_firmware.html[Upgrade storage firmware].
