...
[NOTE]
====
If required, you can verify that all I/O from the hosts have stopped prior to shutting down the storage cluster:
...
.. After all I/O has stopped, wait for 20 minutes before shutting down the cluster.
====
