...
+
IMPORTANT: Element Plug-in for vCenter 5.0 and later is not compatible with VMware vCenter Server 6.7 and 6.5.
...
... Beginning with Element Plug-in for vCenter Server 5.10, a custom URL for the plug-in JSON file.
+
