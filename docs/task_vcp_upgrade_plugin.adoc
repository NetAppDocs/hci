...
[role="tabbed-block"] 
==== 
.Element vCenter Plug-in 5.0 and later 
-- 
...
.Element vCenter Plug-in 4.10 and earlier 
-- 
...
* The plug-in is not compatible with VMware vCenter Server 6.5 for Element Plug-in for VMware vCenter Server 4.6, 4.7, 4.8, 4.9, and 4.10.
=====
