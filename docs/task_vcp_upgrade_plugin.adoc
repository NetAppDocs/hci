...
[IMPORTANT]
====
* The plug-in is compatible with vSphere Web Client version 6.7 U2 for Flash, 6.7 U3 (Flash and HTML5), and 7.0 U1 and U2.
* The plug-in is not compatible with version 6.7 U2 of the HTML5 vSphere Web Client prior to build 13643870.
* The plug-in is not compatible with VMware vCenter Server 6.5 for VCP 4.7 and later.

For more information about supported vSphere versions, see the release notes for https://docs.netapp.com/us-en/vcp/rn_relatedrn_vcp.html#netapp-element-plug-in-for-vcenter-server[your version of the plug-in].
====
