...
If your NetApp HCI installation is running Element software 12.8, you must upgrade the VM hardware version on the management node after upgrading to vSphere to 7.x or 8.x.
