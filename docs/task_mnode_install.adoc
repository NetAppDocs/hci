...
[NOTE]
====
Beginning with the NetApp Element Plug-in for vCenter Server 4.8, substeps a. to e. are performed automatically. As a result, when you run the link:task_mnode_install.html#set_up_the_management_node[setup command], you see output in the setup script similar to the following:
----
