...
////
Changes for 12.2 and later start here. DOC-3054
////

. Download the management services bundle that was previously installed on the existing management node (version 2.15.25 or later) and save it to the `/sf/etc/mnode/` directory.
