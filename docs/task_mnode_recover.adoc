...
. Download the management services bundle that was previously installed on the existing management node (version 2.15.25 or later) and save it in the `/sf/etc/mnode/` directory.
