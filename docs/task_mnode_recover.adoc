...
[NOTE]
====
Beginning with the NetApp Element Plug-in for vCenter Server 4.8, substeps a. to e. are performed automatically. As a result, when you run the <<step_6_recover_mnode_redeploy,redeploy command>>, you see output in the redeploy script similar to the following:
----
