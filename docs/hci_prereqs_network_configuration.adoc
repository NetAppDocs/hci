...
image::H410S_back_panel_ports.png[NetApp H410S storage node network ports]
image::H410C_back_panel_ports.png[NetApp H410C storage node network ports]
...
image::H615S_back_panel_ports.png[NetApp H615S storage node network ports]
