...
All storage nodes support a network topology that uses four network ports; this topology uses ports A through D on H410S and H610S nodes.

NetApp H-series nodes use letters to denote port locations on the back panel:

[[H410S]]
.H410S storage node back panel ports
image::H410S_back_panel_ports.png[NetApp H410S storage node network ports ,align="center",width=50%]

[[H35700E_H410C]]
.H300E, H500E, H700E, and H410C compute node back panel ports
image::H35700E_H410C_back_panel_ports.png[NetApp H410C storage node network ports ,align="center",width=50%]

[[H610S]]
.H610S storage node back panel ports
image::H610S_back_panel_ports.png[NetApp H610S storage node network ports ,align="center",width=50%]

[[H610C]]
.H610C compute node back panel ports
image::H610C_back_panel_ports.png[NetApp H610C storage node network ports ,align="center",width=50%]

[[H615C]]
.H615C compute node back panel ports
image::H615C_back_panel_ports.png[NetApp H615S storage node network ports ,align="center",width=50%]
...
==== VLAN configuration for H300E, H500E, H700E, H410C, H410S, and H610S nodes
This topology option uses the following VLAN configuration on H300E, H500E, H700E, H410C, H410S, and H610S nodes:
