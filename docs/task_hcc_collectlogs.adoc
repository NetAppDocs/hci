...
= Collect log files to help with troubleshooting NetApp HCI
...
[.lead]
Collect NetApp HCI logs in the event that you have trouble with your installation. You can access the log collection area from the NetApp Hybrid Control Dashboard.
*Steps*
