...
The response should return a link to the status of the log collection task:
+
----
{
  "_links": {
    "self": "https://10.117.150.84/logs/1/bundle"
  },
  "taskId": "4157381b-e889-45ce-adb4-92b1842c53ee",
  "taskLink": "https://10.117.150.84/logs/1/bundle"
}
----
