...
summary: As part of a NetApp HCI or standalone SolidFire storage system upgrade, you upgrade the management node.
...
[.lead]
You can upgrade your management node to management node version 12.0 from version 11.0 or later. If you are upgrading from a management node version 10.x, you must migrate your management node settings to a new management node 11.1 VM before you can update to management node 11.3 or later
...
* You have updated your management services bundle to the latest version using Hybrid Cloud Control (HCC):
+
----
...
.. Browse to the registration utility:
+
----
