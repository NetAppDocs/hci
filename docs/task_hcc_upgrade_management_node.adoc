...
. Download the management node ISO for https://mysupport.netapp.com/site/products/all/details/netapp-hci/downloads-tab[NetApp HCI^] from the NetApp Support Site to the management node virtual machine.
+
