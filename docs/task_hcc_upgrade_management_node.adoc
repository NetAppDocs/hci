...
[.lead]
You can upgrade your management node to management node version 12.0 from version 11.0 or later. If you are upgrading from management node version 10.x, you must migrate your management node settings to a new management node 11.1 VM before you can update to management node 11.3 or later. If you are already running an 11.3 management node, you can keep your existing management node if you choose not to upgrade by performing an authentication reconfiguration.
...
Choose this option if after sequentially upgrading (1) management services and (2) Element storage you want to *keep* your existing management node:
...
* Your storage cluster is running Element 11.3 or later.
