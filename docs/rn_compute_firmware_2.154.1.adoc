...
NOTE: You must first upgrade to NetApp Hybrid Cloud Control  version 2.20 before upgrading the firmware on your compute nodes to version 2.154.1. If you fail to do this, HCC will fail the pre-check.
