...
* For H610C and H410C: <<Use NetApp Hybrid Cloud Control UI to upgrade a compute node>> (Recommended)
* For H610C and H410C: <<Use NetApp Hybrid Cloud Control API to upgrade a compute node>>
...
.What you'll need
* If your management node is not connected to the internet, you have downloaded the package from the https://mysupport.netapp.com/site/products/all/details/netapp-hci/downloads-tab[NetApp Support Site^]. To download, select *Compute_Firmware_Bundle* from the drop-down list and click *Go*.
