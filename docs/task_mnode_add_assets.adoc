...
* You have the BMC (hardware) management IP address and administrator credentials.
...
. To add a controller asset (vCenter), compute node (ESXi), or BMC (hardware) to an existing base asset, select one of the following.
+
