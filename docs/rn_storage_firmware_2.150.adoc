...
== What's New
The storage firmware bundle version 2.150 contains a critical bug fix. You can upgrade the storage firmware using the instructions in link:task_hcc_upgrade_storage_firmware.html[Upgrade storage firmware].
