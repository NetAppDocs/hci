...
The storage firmware bundle version 2.150 contains a critical bug fix for H410S (PE-14168). See https://mysupport.netapp.com/site/bugs-online/product[Bugs Online tool^] for further details. You can upgrade the storage firmware using the instructions in link:task_hcc_upgrade_storage_firmware.html[Upgrade storage firmware].
