...
* *System ports*: If you are using NetApp Hybrid Cloud Control for upgrades, you have ensured that the necessary ports are open. See link:https://review.docs.netapp.com/us-en/hci_mgmt_svcs_brycecanyon_review/docs/rancher_prereqs_overview.html#required-ports[Network ports] for more information.
