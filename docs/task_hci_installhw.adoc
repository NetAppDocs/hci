...
TIP: See the link:../media/h-series_isi.pdf[poster] for a visual representation of the instructions.
...
TIP: There are left and right rails on the H615C and H610S. The screw hole needs to be positioned towards the bottom so that the H610S/H615C thumb-screw can secure the chassis to the rail.
