...
IMPORTANT: For H610S storage nodes running Element software version 12.0, you should apply D-patch SUST-909 before you upgrade to storage firmware bundle 2.76. Contact NetApp Support to obtain the D-patch before you upgrade.
