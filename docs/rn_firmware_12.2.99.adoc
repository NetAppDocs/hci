...
permalink: docs/rn_firmware_12.2.99.html
...
////
= Compute firmware 12.2.99 Release Notes
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
|CSESF-293
|When you upgrade to the version 12.2.92 compute node firmware package on H410C, H610C, or H300/500/700E nodes, version 14.21.1000 of the Mellanox network interface card (NIC) firmware is installed, even if it was previously at a newer version.
