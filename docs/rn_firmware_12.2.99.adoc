...
|CSESF-293
|When you upgrade to the version 12.2.92 compute node firmware package on H410C nodes, version 14.21.1000 of the Mellanox network interface card (NIC) firmware is installed, even if it was previously at a newer version.
