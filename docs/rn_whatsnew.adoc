...
* The <<NetApp HCI 1.10>> section describes new features and updates in NetApp HCI version 1.9P1.

* The <<Element 12.5>> section describes new features and updates in NetApp Element 12.3.2.
