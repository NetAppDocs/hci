...
You can now access NetApp HCI upgrading, expansion, monitoring, and concepts information in an easy to navigate format https://docs.netapp.com/us-en/hci/docs/index.html[here^].
