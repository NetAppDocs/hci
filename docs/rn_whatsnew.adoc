...
The June 2020 compute node firmware bundle contains the latest BIOS and BMC feature enhancements, bugfixes, and hardware support for NetApp HCI compute nodes.
