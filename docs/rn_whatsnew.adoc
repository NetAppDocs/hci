...
==== Support for single bond network configuration
You can now use a single bond network configuration for your host with eSDS.

=== NetApp Bugs Online contains known and resolved issues
//Beginning with Element 12.3,
