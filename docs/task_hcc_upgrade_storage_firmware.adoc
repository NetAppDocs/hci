...
TIP: The upgrade process takes approximately 30 minutes.
...
|Up to Date
|The cluster was upgraded to the latest Element version available or the firmware was upgraded to the latest version. This status is also displayed if there is no internet connection.

|Versions Available
|Newer versions of Element and firmware are available for upgrade.
