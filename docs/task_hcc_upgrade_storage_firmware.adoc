...
TIP: The upgrade process takes approximately 30 minutes per storage node. If you are upgrading an Element 12.3 or newer storage cluster to storage firmware newer than version 2.76, the storage nodes will not reboot during the upgrade.
