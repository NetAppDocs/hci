...
* *Management services*: You have updated your management services bundle to the latest version. If you are updating your Element software to version 12.2 for SolidFire Enterprise SDS support, you need management services 2.14.60 or later to proceed.
