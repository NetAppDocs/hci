...
a|
. Download the storage upgrade package from the NetApp Support Site to a device that is accessible to the management node.
...
|Unable to Detect
|NetApp Hybrid Cloud Control shows this stats instead of *Versions Available*. 
