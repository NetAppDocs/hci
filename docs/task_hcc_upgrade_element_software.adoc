...
IMPORTANT: You must upgrade to the latest management services bundle before upgrading your Element software to version 12. If you are updating your Element software to version 12.2 for SolidFire Enterprise SDS support, you need management services 2.14.60 or later to proceed.
