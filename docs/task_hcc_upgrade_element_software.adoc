...
TIP: The file upload will be lost if you navigate away from the browser window.
...
After you resolve the error, you can go back to the page, and click image:hcc_resume_icon.png[resume button].
