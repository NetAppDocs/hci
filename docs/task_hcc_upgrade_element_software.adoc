...
IMPORTANT: If you are upgrading an H610S series node to Element 12.2 and the node is running a version of Element earlier than 11.8, you will need to upgrade Element software (phase 1) and then perform additional upgrade steps (phase 2) for each H610S node in the cluster.
...
IMPORTANT: If you are upgrading an H610S series node to Element 12.2 and the node is running a version of Element earlier than 11.8, you will need to perform additional upgrade steps (phase 2) for each storage node. See <<Upgrading H610S storage nodes to Element 12.2 (phase 2)>>.
