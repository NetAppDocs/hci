...
= NetApp HCI for DevOps: Building an End-to-End CI/CD Pipeline
...
link:nhci_intro[Learn more] about NetApp HCI.
...
* Configuring Jenkins with a new pipeline to run jobs in Kubernetes: https://netapp.io/2019/11/12/netapp-hci-nks-devops-end-to-end-pipeline-part-3/[*_Blog_*] | [*_Video_*]
