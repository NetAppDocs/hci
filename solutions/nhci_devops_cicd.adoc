...
* Deploy a custom application with Kubernetes: https://netapp.io/2019/12/10/netapp-hci-nks-devops-end-to-end-pipeline-part-4/[*_Blog_*] | https://www.youtube.com/watch?v=bYOlqogvyzw&feature=youtu.be[*_Video_*]
