...
[width=100%,cols="2, 4, 4, 4, 4" grid="all"]
|===
| 2+^h|EUC / VCI 2+^h| Private Cloud
|  | Citrix | VMware Horizon | VMware | Red Hat
| Video | links | links | links | links
| Solution Brief | links | links | links | links
| Customer Presentation | links | links | links | links
| Technical Presentation | links | links | links | links
| ORG / FAQ | links | links | links | links
| Competitive Resources | links | links | links | links
|===

[width=100%,cols="2, 5",grid="cols"]
|===
