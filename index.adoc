...
* *NetApp HCI Management documentation*: Introduces NetApp HCI, identifies prerequisites, and provides information about the NetApp Hybrid Cloud Control interface, which enables you to manage your system.
* *NetApp HCI Solutions Catalog*: Lists NetApp HCI Solutions that provide you with the information needed to deploy and operate private clouds, supporting a wide variety of use cases spanning both on-premise and off-premise.  NetApp HCI Solutions deliver value-add capabilities across public, private, hybrid and multi-cloud in technology areas such as DevOps, end user computing, enterprise applications, artificial intelligence, data protection and Data Fabric management.
